...
var pathArray = eventPath.split("?");

var cdnpath = "/static/vendor/gpsseuranta/";
...
preload(
	cdnpath+"images/arrowRi.png",
	cdnpath+"images/arrowLe.png",
	cdnpath+"images/arrowDown.png",
	cdnpath+"images/arrowDown2.png",
	cdnpath+"images/arrowUp.png",
	cdnpath+"images/arrowUp2.png",
	cdnpath+"images/btnPlay.png",
	cdnpath+"images/btnPaused.png"
)
...
var eventId = pathparts[last-2];
var eventpathalku = eventPath.substr(0, eventPath.indexOf(eventId));
var testEventPath = eventpathalku + eventId + "/";
var timeeventhost = "//" + pathparts[2];
...
// Keksien hallintaa ja sovellustilan asettaminen kÃ¤ynnistÃ¤essÃ¤ ohjelmaa
