...
class EssentialApiTestCase1(EssentialApiBase):
    ...
    def test_add_locations(self):
        ...
        device.add_locations([(0, 0.000009, 0)], save=False)
        self.assertEqual(device.locations_encoded, "~n|sfjAA?")
        self.assertEqual(device._location_count, 1)
        device.add_locations([(0, 0.000004, 0)], save=False)
        self.assertEqual(device.locations_encoded, "~n|sfjAA?")
        self.assertEqual(device._location_count, 1)
        device.add_locations([(-1, 0.000009, 0)], save=False)
        self.assertEqual(device.locations_encoded, "`o|sfjAA?@??")
        self.assertEqual(device._location_count, 2)
        device.add_locations([(2, 0.000002, 0)], save=False)
        self.assertEqual(device.locations_encoded, "`o|sfjAA?@??A@?")
        ...
        device.add_locations([(4, 0.000016, 0.00001)], save=False)
        device.add_locations([(5, -0.000019, -0.00001)], save=False)
        device.add_locations([(6, 0.00001, -0.00001)])
        device.refresh_from_db()
        device.add_locations([(7, -0.000019, 0.00001)], save=False)
