        ...
        _setValue(target, index) {
            ...
            const updateInput = () => {
                if (!this._context._input)
                    return;
                let newValue = (target === null || target === void 0 ? void 0 : target.format(this._context._options.display.inputFormat, 'sv-SE')) || '';
                if (this._context._options.multipleDates) {
                    newValue = this._dates
                        .map((d) => d.format(this._context._options.display.inputFormat, 'sv-SE'))
